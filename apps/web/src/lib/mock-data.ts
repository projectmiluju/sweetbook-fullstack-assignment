import type { CohortDetail, CohortSummary, StudentPortfolio } from "@/lib/api";
...
const students: StudentPortfolio[] = [
  {
    ...
    photos: ["https://picsum.photos/seed/bootcamp-team-1/1200/900", "https://picsum.photos/seed/bootcamp-demo-1/1200/900"],
  ...
  },
  {
    ...
    photos: ["https://picsum.photos/seed/bootcamp-design-1/1200/900"],
  ...
  },
  {
    ...
    photos: ["https://picsum.photos/seed/ai-bootcamp-1/1200/900", "https://picsum.photos/seed/ai-bootcamp-2/1200/900"],
...
const cohortDetails: CohortDetail[] = [
  {
    ...
    studentCount: 2,
    students: students
      .filter((student) => student.id === "student-001" || student.id === "student-002")
      .map((student) => ({
        id: student.id,
        name: student.name,
  ...
  },
  {
    ...
    studentCount: 1,
    students: students
      .filter((student) => student.id === "student-003")
      .map((student) => ({
        id: student.id,
        name: student.name,
        roleTrack: student.roleTrack,
...
export const mockCohorts: CohortSummary[] = cohortDetails.map((cohort) => ({
  id: cohort.id,
  name: cohort.name,
...
export function findMockCohort(cohortId: string) {
  return cohortDetails.find((cohort) => cohort.id === cohortId) ?? null;
}

export function findMockStudent(studentId: string) {
